...
namespace EOS.Extensions
{
    ...
    public static class EntityExtensions
    {
        ...
        public static T Add<T>(this EosEntity entity) where T : EosObject, new()
            => entity.IsValid ? entity._internal_world?.ObjectsStorages.Get<T>().Add(entity) : null;
        ...
        public static T Get<T>(this EosEntity entity) where T : EosObject, new()
            => entity.IsValid ? entity._internal_world?.ObjectsStorages.Get<T>().Get(entity) : null;
        ...
        {
            result = null;
            return entity.IsValid && entity._internal_world.ObjectsStorages.Get<T>().TryGet(entity, out result);
        }
        ...
        public static bool Has<T>(this EosEntity entity) where T : EosObject, new()
            => entity.IsValid && entity._internal_world.ObjectsStorages.Get<T>().Has(entity);
        ...
        public static bool Remove<T>(this EosEntity entity) where T : EosObject, new()
            => entity.IsValid && entity._internal_world.ObjectsStorages.Get<T>().Remove(entity);
        ...
        {
            if (entity.IsValid) entity._internal_world.ObjectsStorages.Get<T>().Bump(entity);
        }

        /// <summary>Activates the entity (sets its self-active flag true); effective state still depends on ancestors.</summary>
        public static void On(this EosEntity entity) => entity._internal_world?.Entities.SetActive(entity, true);
        /// <summary>Deactivates the entity (sets its self-active flag false), suspending its whole subtree.</summary>
        public static void Off(this EosEntity entity) => entity._internal_world?.Entities.SetActive(entity, false);
    }
}
